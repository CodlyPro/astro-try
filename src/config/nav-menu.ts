  ...
  infosNav: [
    {
      ...
      items: [
        ...
        {
          title: "Linkedin",
          href: "https://www.linkedin.com/company/nudibranches-technologies/",
          description: "Follow to get the latest updates and news.",
          external: true,
        },
        {
          title: "Source Code",
          href: "https://github.com/nudibranches-tech",
          description: "You want to contribute to the project ? Let's get started!",
          external: true,
        },
      ],
    },
